...
public class C03_Variables {
	...
	public static void main(String[] args) {
		...
		// burada onemli olan bu degiskenleri turune gore islem yapabilecegimdir
		String harf1 ="A";
		char harf2 ='A' ;
		...
		System.out.println(harf1+sayi1+sayi2); // A1020 toplanan ifadelerden biri bile String ise yanyana yazar
		
		System.out.println(sayi1+harf1+sayi2); //10A20
		
		System.out.println(harf1+(sayi1+sayi2)); //A30 oncelik parantez icine verildi
