...
public class C04_Scanner {
	...
	public static void main(String[] args) {
		...
		// isim olarak farkli bir isim yazsak da calisir ama biz sccan demeyi tercih ederiz
		// scan bir obje oldugu icin data turu non-primitive'dir
		// prtimitive data turleri sadece deger icerirken,
		// non-primitive data turleri degerin yaninda method'lar barindirir.
		// scan. dedigimizde kullanabilecegimiz bu method'lari gorebilir.
