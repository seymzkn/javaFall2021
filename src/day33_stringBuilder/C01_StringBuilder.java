...
public class C01_StringBuilder {
	...
	public static void main(String[] args) {
		...
		System.out.println(sb.capacity()); //16 sb'in kapasitesini verir.uzunlugunu belirtmezsek 16 karakter sigacak sekilde sb olusturulur
		
		StringBuilder sb2= new StringBuilder("Java candir");
		
		System.out.println(sb2.length()); // 11
		System.out.println(sb2.capacity()); //27 11 in uzerine 16 daha ekledi
		...
		sb.append("anlasildi mi", 3, 4);  //3. indexten baslar 4. indexe kadar yazdirir
		System.out.println(sb); //Java candira
		
		sb.append("anlasildi mi", 3, 6); 
		System.out.println(sb); //Java candiraasi
