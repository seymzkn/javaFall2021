...
public class C03_Sort {
	...
	public static void main(String[] args) {
		...
		Collections.sort(isimler); //alfabeye gore siraladi
		System.out.println(isimler); //[Emrah, Ferhat, Kutlu] natural order
		
		isimler.add("filiz");
		System.out.println(isimler); //[Emrah, Ferhat, Kutlu, filiz]
		Collections.sort(isimler);
		System.out.println(isimler); //buyuk harflerin ascii degerleri daha kucuk oldugu icin once buyuk harfler yazilir
