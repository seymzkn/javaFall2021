...
public class Market {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 7; i++) {
			...
			System.out.println("Lutfen " + gunler.get(i) + " gunu icin kazancinizi giriniz");
		...
		Market_Methods.getOrtalamaninUstundeKazancGunleri();
		Market_Methods.getOrtalamaninAltindaKazancGunler();
