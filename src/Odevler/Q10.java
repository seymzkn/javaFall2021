...
public class Q10 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lutfen toplamak istediginiz sayi adedini n2,3 veya 4 den biri olarak secin");
	...
	public static void dortSayiTopla() {
		Scanner scan=new Scanner(System.in);
		System.out.println("Lutfen dort sayi giriniz \nher sayidan sonra entere basin");
		double sayi1=scan.nextDouble();
		double sayi2=scan.nextDouble();
		double sayi3=scan.nextDouble();
		double sayi4=scan.nextDouble();
		
		System.out.println("Girdiginiz 3 sayinin toplami : " + (sayi1+sayi2+sayi3+sayi4));
