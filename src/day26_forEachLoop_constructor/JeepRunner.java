...
public class JeepRunner {
	...
	public static void main(String[] args) {
		...
		Jeep jeep1=new Jeep (); //default constructor calisir 
		
		System.out.println(jeep1.fiyat + " " + jeep1.ilanNo + " " + " " + jeep1.marka +
							" " + jeep1.model+ " " + jeep1.yil); //10000 1001 null null 2001
		
		// jeep class'inda variable'lar instance variable'lar olduklarindan
		...
		jeep1.yakit("benzin"); //Araba yakit olarak benzin kullanilir
