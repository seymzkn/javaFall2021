...
public class C02_Replace {
	...
	public static void main(String[] args) {
		...
		sonuc=sonuc.replace(".", "");	//1000è cevirip sonuca assign ettik
										// = oldugu icin sonuc kalici olarak degisti
		
		System.out.println(sonuc);
		
		
		if (Integer.valueOf(sonuc)>1000) { //direk sonuc>1000 diyemeyiz string i int ile kiyaslama yapamayiz bu nedenle wrapper class kullandik
